						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								...
								<tr>
									...
									<td class="text-left">
										<button class="btn btn-success btn-xs">批准领取</button>
										<button class="btn btn-danger btn-xs">拒绝领取</button>
										<a href="res_back.jsp?rid=1" class="btn btn-primary btn-xs">归还用品</a>
									</td>
								</tr>
								<tr>
									<td class="text-center"><img src="upload/res/nophoto.png" class="img" style="width:30px;"> 记事本</a>
									...
									<td class="text-left">
										<button class="btn btn-success btn-xs">批准领取</button>
										<button class="btn btn-danger btn-xs">拒绝领取</button>
										<a href="res_back.jsp?rid=1" class="btn btn-primary btn-xs">归还用品</a></td>
								</tr>
								<tr>
									<td class="text-center"><img src="upload/res/nophoto.png" class="img" style="width:30px;"> 记事本</a>
									</td>
